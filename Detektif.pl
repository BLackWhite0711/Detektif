...
sub help {
    ...
    print color("bold white"),"perl Detektif.pl -i example.com\n";
    print item('2'),"Phone Number Information ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -n xxxxxxx\n";
    print item('3'),"Find IP Address And E-mail Server ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -mx example.com\n";
    print item('4'),"Domain Whois Lookup ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -w example.com\n";
    print item('5'),"Find Website/IP Address Location ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -l example.com\n";
    print item('6'),"Bypass CloudFlare ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -c example.com\n";
    print item('7'),"Domain Age Checker ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -a example.com\n";
    print item('8'),"User Agent Info ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -ua Mozilla/5.0 xxxxxxxxxxxxxxxxxxxx\n";
    print item('9'),"Check Active Services On Resource";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -p 127.0.0.1\n";
    print item('10'),"Credit Card Bin Checker ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -b 123456\n";
    print item('11'),"Subdomain Scanner ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -s example.com\n";
    print item('12'),"E-mail Address Checker ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -e example@gmail.com\n";
    print item('13'),"Content Management System Checker ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl Detektif.pl -cms example.com\n";
}

##### Banner #######
sub banner {
    if ($^O =~ /MSWin32/) {system("mode con: cols=100 lines=29");system("cls"); }else { system("resize -s 28 87");system("clear"); }
    print "____   ______  _____  ______  __   __  _____   _  ______ \n";
    print " ||  \\  ||  |  |_   _| ||   |  ||  // |_   _| | | ||     \n";
    print " ||   \\ ||___    | |   ||___   || //    | |   | | ||__   \n";
    print " ||  // ||       | |   ||      || \\     | |   | | ||     \n";
    print " ||__/  ||____/  |_|   ||____/ ||  \\    |_|   |_| ||     \n";
    print " ~~~~~  ~~~~~~~  ~~~   ~~~~~~~ ~~   ~~  ~~~   ~~~ ~~     \n";
    print "                                              \n";
    print color('bold green'),"                                                     V.1\n\n";
    print "                                \033[0;31m[\033[0;33m127.0.0.1\033[0;31m] \033[0;37m|_|\033[0;31m [\033[1;34m192.168.1.1\033[0;31m] \033[0;37m\n";
    print "                                \033[0;31m[\033[0;37mDitata Oleh  BLackWhiteTeam\033[0;31m]\033[0;37m\n";
    print " \n";
}
